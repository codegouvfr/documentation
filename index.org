...
Quelque soit votre contexte, vous pouvez demander à vos pairs 
...
avant d'aller plus loin, il en est trois autres à ne pas négliger : les fonctionnalités, la sécurité et les communautés. 
...
peut être analysé sur la base de divers critères. On pourra analyser deux facettes : 
