...
Si ces sujets sont nouveaux pour vous, voir le @ref{Glossaire, , glossaire}.
#+end_export
...
Si un *DCO* (/Developer Certificate of Origin/) est présent, c’est
simple : chaque contributeur doit avoir l’accord de sa hierarchie, et
signer avec un simple /sign-off/ chacun de ses /commits/.

Si un *CLA* (/Contributor Licence Agreement/) est présent, le service
...
Certains CLA permette de sous-licencier des contributions sous des
