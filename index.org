...
Au début du fichier ~README.md~ d'un dépôt, vous pouvez ajouter l'une de
ces lignes de code permettant d'afficher un badge et de prévenir vos
utilisateurs :

: https://img.shields.io/badge/code.gouv.fr-contributif-blue
: https://img.shields.io/badge/code.gouv.fr-ouvert-mediumseagreen
: https://img.shields.io/badge/code.gouv.fr-publi%C3%A9-orange
