...
contribuer à leur projet. Une attention particulière doit être portée
au CLAs.
...
extérieurs à Element sous une licence propriétaire ([[https://static.element.io/legal/contributor-license-agreement.pdf][Article 2 du CLA]]).
...
#+begin_export md
 <iframe src="https://code.gouv.fr/guides/juridique/" title="guide juridique interactif"></iframe> 
#+end_export
...
GitHub ou le groupe GitLab soit ajouté dans [[https://git.sr.ht/~codegouvfr/codegouvfr-sources/tree/master/item/comptes-organismes-publics.yml][ce fichier]].
