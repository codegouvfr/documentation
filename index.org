...
Pour plus de détails sur le copyleft fort, [[file:index-temp.org::#difference-copyleft-faible-fort][se référer à cette section]].
...
à copyleft [[file:index-temp.org::#difference-copyleft-faible-fort][faible ou fort]].
...
* Glossaire
  ...
  :END:
  :LOGBOOK:
  CLOCK: [2024-07-24 mer. 22:57]--[2024-07-24 mer. 22:59] =>  0:02
  :END:
...
* COMMENT Monter un Open Source Programme Office
  :PROPERTIES:
