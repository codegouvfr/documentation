...
Quelque soit votre contexte, vous pouvez demander à vos paires 
s'ils ont connaissance de logiciels libres adaptés à votre domaine 
et vos besoins. 
...
afin d'éviter d'utiliser un logiciel sans en avoir les droits. 
...
Si la licence est l'élément indispensable que l'on vérifie 
avant d'aller plus loin, il en est trois autres à ne pas négliger : les fonctionnalités, la sécurité et la communauté. 

**** Fonctionnalités 

Il n'est pas rare qu'un logiciel ne couvre pas entièrement les besoins fonctionnels visés. 
Et c'est là que la magie opère : vous pouvez [[#contribuer-a-un-logiciel-libre][contribuer]] 
au projet et ainsi participer à l'effort collectif, récompenser la communauté. 
...
et leur moyen d'intégration dans le projet (ex. "Est-ce facile à intégrer 
via des plugins ou cela nécessite-t-il une modification du coeur ?"). 

**** Sécurité 

La sécurité est un sujet que l'on ne peut plus ignorer. Cet aspect d'un projet 
peut être analysé sur la base de divers critères. 
La OpenSSF dresse la liste des [[https://www.bestpractices.dev/fr/criteria][critères]] 
qu'elle utilise pour labelliser des projets. C'est une base de départ solide. 

**** Communauté 

Avant d'utiliser un projet, nous vous conseillons de regarder l'état de santé 
de la communauté qui l'entoure. Pour cela, il existe plusieurs métriques 
...
Un projet entouré d'une grande et forte communauté nécessite peu d'investissement. Par contre, il est plus compliqué d'influencer sa trajectoire. 
Un projet orphelin de communauté demandera plus d'investissement mais vous aurez la liberté de choisir quand ou où investir. 
