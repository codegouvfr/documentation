...
savoir comment le faire, vous pouvez vous référer à la [[*Trouver des solutions libres][sections ci-dessus.]]
...
Cela étant dit, pour se repérer dans l’écosystème, un certain nombres de
...
licence par défaut, mais qu’il y est un changement au cours du
temps. Par exemple :
...
l’application Tchap) [[https://element.io/blog/synapse-now-lives-at-github-com-element-hq-synapse/][font signer un CLA avec une exception à l’AGPL pour
...
sous licences libres, il faut bien comprendre que les libertés octroyées
par ces licences permettent en tout temps à n’importe quel acteur de
réutiliser le code produits par des agents public, et ce, même à des
fins lucratives.
...
LibreOffice]], [[https://www.ccomptes.fr/sites/default/files/2024-07/20240710-S-2024-0754-Pilotage-transformation-numerique-Etat-par-direction-interministerielle-du-numerique.pdf][le fait que le système de design de l’État (DSFR) permet
