...
lors de l’édition de lien (quelle soit dynamique ou statique). En
générale, ce sont des bibliothèques logicielles qui, seules n’ont pas de
grande utilité, répondant à des fonctions de bases, mais nécessaires au
fonctionnement d’un logiciel complet.
