...
- Quelles sont les bonnes pratiques de publications ?
- Voir good governance handbook
- Mettre README.md, CONTRIBUTING.md, LICENCE.md

** NEXT Bonnes pratiques pour la documentation
- Les bonnes pratiques pour la documentatition
- writesthedocs

** NEXT Les politiques ministérielles déjà publiées
** NEXT Se répérer dans l’écosytème logiciel libre et open source
