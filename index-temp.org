...
à l’interprétation des administrations.
...
ne seront pas redistribuées. Dans ce cas de figure là, mettre le code
...
TODO : définir logiciel notamment la différence avec un code source. La
question : Qu'est ce qu'un dépôt de code source et en quoi est-ce
différent d'un logiciel ?
