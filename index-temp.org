...
** STRT Le marché public pour le logiciel libre

La commande publique *peut faire appel à un logiciel libre précis*.

En effet, à défaut des logiciels privatifs, un logiciel libre peut être
utilisé, copié, modifié, par n’importe qui, y compris des entreprises
...
principes de libertés d’accés et d’égalité de traitement du Code des
marchés publics. Le logiciel libre, /par définition/, garantit le
principe d’égalité.

Plus encore, la commande publique *peut exiger une solution numérique
faite de logiciels libres*.
...
caractéristiques juridiques la possibilité de copier, modifier, et
redistribuer.

Néanmoins, précisons. La commande publique ne sera pas sur l’acquisition
d’un logiciel libre, mais sur la prestation de service autour de ce
logiciel libre.

Un cas particulier cependant : une commande publique portant sur le
développement d’un logiciel libre. Dans ce cas-là, deux points
d’attention. D’abord la dévolution des droits de propriété
intellectuelle doit être prévue par une clause spécifique. [[https://adullact.org/IMG/pdf/GuideLLadministrations-V1.2.0.pdf][Le guide de
l’adullact va plus loin]]. Ensuite, vient la question de l’égalité des
candidats. Ce cas est plus délicat lorsqu’une entreprise est déjà engagé
dans la gouvernance d’un logiciel libre que l’administration pourrait
être amené à passer commande. Néamoins, cela ne saurait remettre en
cause l’égalité des candidats, puisque le logiciel étant libre, chacun
est libre de créer un /fork/ et d’avoir droit de /commit/ par défaut,
d’autant plus que chaque candidat a en réalité tout intérêt à mutualiser
les efforts et éviter les /forks/. [[https://www.conseil-etat.fr/fr/arianeweb/CE/decision/2011-09-30/350431][La décision du Conseil d’État]] du 30
septembre 2001 va dans ce sens.


- dire les commandes du marché public peuvent demander un logiciel libre
  en particulier
  - Canevet page 524
- mentionner le cadre de la loi qui donne la priorité aux logiciels libre
  - par exemple loi « relative à l’enseginement supérieur et à la
    recherche » article 6 modifiant artcile L.123-4-1
...
la réponse est "oui, si vous avez l'accord de votre manager".

Le document qui acte de cette possibilité de contribuer à des logiciels
libres existants est effectivement la politique de contribution open
source de 2018.

C'est aussi quelque chose que nous réaffirmerons dans la documentation
de la mission logiciels libres: https://code.gouv.fr/documentation/

Dans les faits, ça peut être plus compliqué que de simplement obtenir
l'accord de votre manager, notamment s'il y a un CLA à signer pour
contribuer au projet (là il faudra que vos services juridiques s'en
mêlent). S'il n'y a qu'un DCO (https://developercertificate.org), vous
pouvez l'accepter sans mobiliser vos services juridiques.
