...
savoir comment le faire, vous pouvez vous référer à la [[*Trouver des solutions libres][section ci-dessus.]]
...
réutiliser le code produit par des agents publics, et ce, même à des
fins lucratives.
...
fortement conseillé. Pour plus de détails sur le copyleft fort, [[*Qu'est-ce que le « copyleft » ?][se
