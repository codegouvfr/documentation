...
La mission logiciels libres liste (1) des logiciels libres du secteur
public et à forte valeur ajoutée pour toute l'administration, (2) les
dépôts de code source publiés par tous les organismes publics et (3)
les logiciels libres recommandés pour toute l'administration :
...
- [[https://code.gouv.fr/sources][code.gouv.fr/sources]] liste de façon centralisée tous les dépôts de
  codes sources publiés par l’administration sur des forges ;
